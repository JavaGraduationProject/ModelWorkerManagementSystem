<template>
  <div>
    <div class="container">
      <div
        class="login-form"
        style="backgroundcolor: rgba(183, 174, 174, 0.5); borderradius: 22px;"
      >
        ...
        >
          <!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">劳模工号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshigonghao" class="input" type="text" placeholder="劳模工号">
			   </div>
			 </div> -->
          <el-form-item
            label="劳模工号"
          ...
          <!-- <div v-if="tableName=='jiaoshi'" class="input-group">
			   <div class="label">劳模姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiaoshixingming" class="input" type="text" placeholder="劳模姓名">
			   </div>
			 </div> -->
          <el-form-item
            label="劳模姓名"
  ...
  methods: {
    ...
    login() {
      ...
      if (
        ...
        !this.$validate.isMobile(this.ruleForm.lianxidianhua)
      ) {
