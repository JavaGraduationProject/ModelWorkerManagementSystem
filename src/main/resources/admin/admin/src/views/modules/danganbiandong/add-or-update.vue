          ...
          <el-form-item class="input" label="联系电话" prop="lianxidianhua">
              <el-input v-model="ruleForm.lianxidianhua" 
                placeholder="联系电话" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="材料更新" prop="cailiaogengxin">
          <file-upload
          tip="点击上传材料更新"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.cailiaogengxin?ruleForm.cailiaogengxin:''"
          @change="cailiaogengxinUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.cailiaogengxin" label="材料更新" prop="cailiaogengxin">
            <el-button type="text" size="small" @click="download(ruleForm.cailiaogengxin)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.shenqingriqi" label="申请日期" prop="shenqingriqi">
              <el-input v-model="ruleForm.shenqingriqi" 
                placeholder="申请日期" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="档案更新" prop="dangangengxin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="档案更新"
                  v-model="ruleForm.dangangengxin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dangangengxin" label="档案更新" prop="dangangengxin">
                    <span>{{ruleForm.dangangengxin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.lianxidianhua = true;
            continue;
	            	            ...
	            	            if(o=='dangangengxin'){
            this.ruleForm.dangangengxin = obj[o];
	    this.ro.dangangengxin = true;
            continue;
          }
	            	            if(o=='cailiaogengxin'){
            this.ruleForm.cailiaogengxin = obj[o];
	    this.ro.cailiaogengxin = true;
            continue;
          }
	            	            if(o=='shenqingriqi'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `danganbiandong/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.danganbiandongCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    back() {
      ...
      this.parent.contentStyleChange();
                                                                                                ...
                                                                                                cailiaogengxinUploadChange(fileUrls) {
                this.ruleForm.cailiaogengxin = fileUrls;
				this.addEditUploadStyleChange()
            },
                                                	addEditStyleChange() {
	  this.$nextTick(()=>{
