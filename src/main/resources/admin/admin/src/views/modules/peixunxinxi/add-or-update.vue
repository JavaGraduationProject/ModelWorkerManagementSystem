          ...
          <el-form-item class="input" v-if="ruleForm.faburiqi" label="发布日期" prop="faburiqi">
              <el-input v-model="ruleForm.faburiqi" 
                placeholder="发布日期" readonly></el-input>
                                                                                                            ...
                                                                                                            <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="培训目标" prop="peixunmubiao">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="培训目标"
                  v-model="ruleForm.peixunmubiao" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.peixunmubiao" label="培训目标" prop="peixunmubiao">
                    <span>{{ruleForm.peixunmubiao}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.peixunneirong = true;
            continue;
	            	            ...
	            	            if(o=='peixunmubiao'){
            this.ruleForm.peixunmubiao = obj[o];
	    this.ro.peixunmubiao = true;
            continue;
          }
	            	            if(o=='shoukejiangshi'){
