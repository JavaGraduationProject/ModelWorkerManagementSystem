        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.xingqi"
                placeholder="星期" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="上课时间" prop="shangkeshijian">
          <el-select v-model="ruleForm.shangkeshijian" placeholder="请选择上课时间">
            <el-option
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                        ...
                                        this.shangkeshijianOptions = "第一节,第二节,第三节,第四节,第五节,第六节,第七节".split(',')
                                              },
                                                                // 多级联动参数
                                                                                  info(id) {
      this.$http({
