          ...
          <el-form-item class="input" label="性别" prop="xingbie">
              <el-input v-model="ruleForm.xingbie" 
                placeholder="性别" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="获奖时间" prop="huojiangshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.huojiangshijian" 
                type="date"
                placeholder="获奖时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huojiangshijian" label="获奖时间" prop="huojiangshijian">
              <el-input v-model="ruleForm.huojiangshijian" 
                placeholder="获奖时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="惩罚时间" prop="chengfashijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.chengfashijian" 
                type="date"
                placeholder="惩罚时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.chengfashijian" label="惩罚时间" prop="chengfashijian">
              <el-input v-model="ruleForm.chengfashijian" 
                placeholder="惩罚时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                                            </el-row>
                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="获奖内容" prop="huojiangneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="获奖内容"
                  v-model="ruleForm.huojiangneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.huojiangneirong" label="获奖内容" prop="huojiangneirong">
                    <span>{{ruleForm.huojiangneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="惩罚内容" prop="chengfaneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="惩罚内容"
                  v-model="ruleForm.chengfaneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.chengfaneirong" label="惩罚内容" prop="chengfaneirong">
                    <span>{{ruleForm.chengfaneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  data() {
	...
	huojiangneirong : false,
	chengfashijian : false,
	chengfaneirong : false,
      },
            ruleForm: {
                	        jiaoshigonghao: '',
	                        	        jiaoshixingming: '',
	                        	        ...
	                        	        chengfaneirong: '',
                                                                                                              ...
                                                                                                              rules: {
                  jiaoshigonghao: [
                            { required: true, message: '劳模工号不能为空', trigger: 'blur' },
                                    	                                                              ],
                  jiaoshixingming: [
                            { required: true, message: '劳模姓名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xingbie: [
                                    	                                                              ],
                  huojiangshijian: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xingbie = true;
            ...
            this.ruleForm.huojiangshijian = obj[o];
	    this.ro.huojiangshijian = true;
            continue;
          }
	            	            if(o=='huojiangneirong'){
            this.ruleForm.huojiangneirong = obj[o];
	    this.ro.huojiangneirong = true;
            continue;
          }
	            	            if(o=='chengfashijian'){
            this.ruleForm.chengfashijian = obj[o];
	    this.ro.chengfashijian = true;
            continue;
          }
	            	            if(o=='chengfaneirong'){
            this.ruleForm.chengfaneirong = obj[o];
	    this.ro.chengfaneirong = true;
            continue;
          }
	                    }
                                                                                                                              }
